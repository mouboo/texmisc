...
\definecolor{headingcolor}{rgb}{0,0,0.6}
%Section formatting 
...
\begin{tabularx}{\textwidth}{r|X}	
	...
	&\footnotesize{\vspace{-5pt}
		...
		\item Praktikplats termin 6: Papegojelyckans äldreboende, Lunds kommun.
		Självständigt leda fysisk aktivitet med äldre, fallprevention, utvärdering och uppföljning av åtgärder, bedömning av hjälpmedelsbehov, arbete med kvalitetsregister såsom BPSD och Senior Alert.
...
\begin{itemize}[leftmargin=0.8em]
	...
	\item Har använt Exorlive och Physiotools för träningsprogram.
	...
	\item Presterade bland de 0,7\% bästa på högskoleprovets språkdel.
...
\begin{tabularx}{\textwidth}{X}
	...
	\begin{itemize}[leftmargin=0.8em]
		...
		\item Är både analytiskt lagd och praktiskt lösningsfokuserad.
...
\\
Anna Pyrih, handledare på praktikplatsen Papegojelyckans äldreboende, termin 6\\ Tel. arbete: 046-3596182, Tel.privat:0793366997, E-post: anna.pyrih@lund.se \\
\end{tabularx}
